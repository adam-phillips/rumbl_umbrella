defmodule Rumbl.Multimedia do
  ...
  @doc """
  	Compose and pass queryable to Category context to alphabetize
  """
  ...
  @doc """
    Create an Annotation struct that's piped into the Annotation changeset,
  ...
  @doc """
    Retrieve all annotations for a given Video from the database where the id
    is greater than the `since_id` parameter, which defaults to 0
  """
